...
class HR_Nomina(models.Model):
    ...
    empleado_id = fields.Many2one('hr.employee', string='Nombre', store=True)
    dias_trabajados = fields.Integer(string='Días trabajados', default=30 , store=True)
    dias_ausentes = fields.Integer(string='Días ausentes', default=0 , store=True)
    licencia = fields.Integer(string='Licencia', default=0 , store=True)
    comienzo = fields.Date(string='Inicio de licencia' , store=True)
    permisos = fields.Integer(string='Permisos', default=0)
    prestamo = fields.Integer(string='Préstamo', default=0 , store=True)
    ...
    b_cumplimiento = fields.Integer(string='Bono por cumplimiento', default=0 , store=True)
    b_estudio = fields.Integer(string='Bono estudios anual', default=0 , store=True)
    b_est_trabajador = fields.Integer(string='Bono de estudios (trabajador)', default=0 , store=True)
    b_est_especial = fields.Integer(string='Bono de estudios (especial)', default=0 , store=True) 
